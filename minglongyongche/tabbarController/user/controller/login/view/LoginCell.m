...
- (UITextField *)codeTextField {
    if (!_codeTextField) {
        ...
        _codeTextField.attributedPlaceholder = [NSString setFirstPart:@"手机号登录即为注册" firstFont:15 firstColor:MLGrayColor secondPart:@"" secondFont:0 secongColor:MLGrayColor];
